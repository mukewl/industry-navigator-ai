  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-1 flex-col overflow-y-auto p-3">
        ...
        {/* Architecture + Roadmap — pinned at bottom */}
      ...
      <div className="shrink-0 border-t border-white/10 px-3 py-2 flex items-center justify-between">
        <p className="text-[10px] font-normal tracking-tight text-white/48">Internal</p>
        <ThemeToggle className="text-white/48 hover:bg-white/10 hover:text-white/80" />
      </div>
    </aside>
  );
};
